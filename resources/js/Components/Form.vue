...
const flexColumns = computed(() => {
    if (props.has_columns) return 'lg:flex-row'
});
...
<template>
    <div class="mx-auto px-4 lg:px-0 w-full" :class="sizeWidth">
            ...
            <p class="font-normal text-sm py-2"> {{ description }}</p>
                ...
                <form @submit.prevent="submit">
                    <div  class="flex flex-col gap-6">
                        <div class="flex w-full gap-6 lg:gap-6 flex-col pt-4" :class="flexColumns">
                            <slot name="form"/>
                        </div>
                        <!-- <div class="card flex justify-content-center"> -->
                        <div class="flex flex-row justify-between items-center" v-if="show_submit">
                            <slot name="remember"/>
